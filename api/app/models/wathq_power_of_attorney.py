...
class PowerOfAttorney(Base):
    ...
    # Relationships
    allowed_actors = relationship("PoaAllowedActor", back_populates="power_of_attorney", cascade="all, delete-orphan")
    principals = relationship("PoaPrincipal", back_populates="power_of_attorney", cascade="all, delete-orphan")
    agents = relationship("PoaAgent", back_populates="power_of_attorney", cascade="all, delete-orphan")
    text_list_items = relationship("PoaTextListItem", back_populates="power_of_attorney", cascade="all, delete-orphan")
...
class PoaAllowedActor(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    poa_id = Column(Integer, ForeignKey('wathq.power_of_attorney.id', ondelete='CASCADE'), nullable=False)
...
class PoaTextListItem(Base):
    ...
    # Relationship
    power_of_attorney = relationship("PowerOfAttorney", back_populates="text_list_items")
