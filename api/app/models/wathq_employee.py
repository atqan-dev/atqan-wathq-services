...
class Employee(Base):
    ...
    # Relationships
    employment_details = relationship("EmploymentDetail", back_populates="employee", cascade="all, delete-orphan")
...
class EmploymentDetail(Base):
    ...
    employee_id = Column(Integer, ForeignKey('wathq.employees.employee_id', ondelete='CASCADE'), nullable=False)
